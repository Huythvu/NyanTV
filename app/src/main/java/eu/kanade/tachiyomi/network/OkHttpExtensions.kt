        ...
        enqueue(object : Callback {
            ...
            override fun onFailure(call: Call, e: IOException) {
                ...
                continuation.resumeWithException(
                    IOException(e.message, e).apply { stackTrace = callStack }
                )
            }
        })
...
// Ohne context receiver – Json explizit übergeben
@OptIn(ExperimentalSerializationApi::class)
inline fun <reified T> Response.parseAs(json: Json): T {
    return decodeFromJsonResponse(json, json.serializersModule.serializer(), this)
}
